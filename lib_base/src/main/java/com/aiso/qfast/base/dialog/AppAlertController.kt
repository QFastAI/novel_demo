...
class AppAlertController(
    ...
    private lateinit var alertParams: AppDialogParams.AlertParams
    ...
    private lateinit var buttonCenterLine: View
    ...
    internal fun setupView() {
        ...
        buttonCenterLine = window.findViewById(R.id.bottom_center_line)
    ...
    private fun setupItems() {
        ...
        if (itemLayoutRes == null) {
            itemLayoutRes = R.layout.theme_dialog_list_item_layout
        }
        recyclerView.visibility = View.VISIBLE
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.adapter = ItemAdapter(
            dialog, arrays, itemLayoutRes, alertParams.itemClickListener
        )
    ...
    private fun findCurrentSelectedPosition(list: List<AppDialogParams.Item>): Int {
        var position = -1
    ...
    private fun setupButton() {
        ...
        alertParams.positiveButtonTextColor?.let {
            positiveButton.setTextColor(it)
        }

        alertParams.negativeButtonTextColor?.let {
            negativeButton.setTextColor(it)
        }
        ...
        when {
            showPositiveButton && showNegativeButton -> {
                ...
                buttonCenterLine.visibility = View.VISIBLE
            ...
            showPositiveButton -> {
                ...
                buttonCenterLine.visibility = View.GONE
                positiveButton.text = alertParams.positiveButtonText
            }
    ...
    private class ItemAdapter(
        ...
        private val arrays: List<AppDialogParams.Item>,
    ...
    fun setAlertParams(alertParams: AppDialogParams.AlertParams) {
